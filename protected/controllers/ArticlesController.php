...
//                'actions'=>array('admin','delete'),
    ...
    public function actionCreate()
    {
        ...
        if(isset($_POST['Articles']))
        {
            ...
            $model->modifi = new CDbExpression('NOW()');
            $model->categ = $_POST['categ'];
        ...
        $this->render('create',array(
            'model'=>$model,
            'categList' => Categories::getAllCategs(),
            'groupList' => Subcategories::getAllSubCategs(),
        ));
    }
    ...
    public function actionDisplay($categ = '', $subcateg = '')
    {
        if(!empty($subcateg))
        {
            $criteria = array('condition' => 'categ = "'.$categ.'" AND groups = "'.$subcateg.'"');
        }
        else
        {
            $criteria = array('condition' => 'categ = "'.$categ.'"');
        }
